self.onmessage = function (event) {
    ...
    // Warning: This implementation is not perfect and may not work in all cases (especially with objects)
    // Otherwise, it should work for most simple cases
    // This implementation will be improved in the future for senarios where the data is more complex (e.g. objects)
    console.table = (data) => {
